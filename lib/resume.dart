    ...
    return Scaffold(
      ...
      children: [
        Padding(
          ...
          child: Text('George Vuxton', style: Styles.mediumText),
        ),
        ...
        corpDatesLocationRow(
            'SunTrust Banks', '2016 - 2018', 'Tallahassee, FL'),
        Text(
        ...
        Text(
            '\"Wait, how long was he at Publix? And cashier to seafood clerk seems incredibly lateral, he must have really been starting to hate people. That or he just has a thing for fish. Judging by the next job after Publix I\'m inclined to think it\'s the latter."',
            style: Styles.verySmallText),
        Padding(
          padding: const EdgeInsets.only(top: 10),
        ...
        corpDatesLocationRow(
            'Sonny\'s Barbeque', '2006 - 2006', 'Tallahassee, FL'),
        Text(
